...
% 
% 	methods
function [OffDec, OffVel] = Operator_MOPSOonly(Problem, Population, div)
    %% Parameter setting
    ...
    [OffDec, OffVel] = OperatorPSOonly(Problem,Population,Pbest,Archive(REP)); %更新粒子位置和速度，每个粒子向自己的pbest和全局的gbest学习
