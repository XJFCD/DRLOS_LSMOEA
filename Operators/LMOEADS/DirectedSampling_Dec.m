function GuidingSolution = DirectedSampling_Dec(Problem,Population,Ns,Nw,RefV)
...
% E-mail: shufen.qin@stu.tyust.edu.cn
    ...
    SampleDec  = GenerateSampleSolution(Problem,RandSample,Direction);
    SampleSolution = Problem.Evaluation(SampleDec);
...
%    end
% end
function SampleDec = GenerateSampleSolution(Problem,RandSample,Direct)
