...
% 
%     methods
function OffDec = Operator_LMOEADS_Dec(Problem,Population,RefV,Nw,Ns)
    % Parameter settings
    ...
    GuidingSolution = DirectedSampling_Dec(Problem,Population,Ns,Nw,RefV);
    OffDec       = DoubleReproduction_Dec(Problem,Population,GuidingSolution,RefV);
    %end
end
%     end
% end